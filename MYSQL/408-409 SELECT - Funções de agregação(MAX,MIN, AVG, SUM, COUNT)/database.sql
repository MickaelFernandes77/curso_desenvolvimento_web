-- As funções de agregação servem para permitirem  fazer seleções artiméticas, nas querys.

-- MAX: retorna o maximo
-- MIN: retorna o mínimo
-- AVG: retorna a média
-- SUM: Soma a quantidade de registros de uma coluna(com base em uma coluna)
...
INSERT INTO tb_cursos(id_curso, imagem_curso, nome_curso, resumo, data_cadastro, ativo, investimento, carga_horaria) VALUES (1, 'curso_node.jpg', 'Curso Completo do Desenvolvedor NodeJS e MongoDB', 'Resumo do curso de NodeJS', '2018-01-01', 1, 159.99, 15), 
...
-- MIN
SELECT nome, MIN(investimento) FROM tb_cursos;
SELECT nome, MIN(investimento) FROM tb_cursos WHERE ativo = true;
...
-- AVG
SELECT AVG(investimento) FROM tb_cursos;
